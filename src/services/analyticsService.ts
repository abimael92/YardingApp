...
const mockCrewPerformance: CrewPerformance[] = [
  { crewId: "crew-1", crewName: "Crew A", jobsCompleted: 85, revenue: 125000, avgRating: 4.8, onTimeRate: 94 },
  { crewId: "crew-2", crewName: "Crew B", jobsCompleted: 72, revenue: 108000, avgRating: 4.9, onTimeRate: 97 },
  { crewId: "crew-3", crewName: "Crew C", jobsCompleted: 68, revenue: 98000, avgRating: 4.7, onTimeRate: 91 },
]

const mockSeasonalForecast: SeasonalForecast[] = [
  { month: "Feb 2025", predictedJobs: 52, predictedRevenue: 47500, confidence: 85 },
  { month: "Mar 2025", predictedJobs: 58, predictedRevenue: 53200, confidence: 88 },
  { month: "Apr 2025", predictedJobs: 65, predictedRevenue: 59800, confidence: 90 },
  { month: "May 2025", predictedJobs: 72, predictedRevenue: 66100, confidence: 92 },
  { month: "Jun 2025", predictedJobs: 78, predictedRevenue: 71500, confidence: 90 },
]
...
export const analyticsService = {
  ...
  getJobCompletionRate: (): Promise<number> =>
    asyncify(() => 87.5), // 87.5% completion rate

  getClientRetentionRate: (): Promise<number> =>
    asyncify(() => 82.3), // 82.3% retention rate
}
