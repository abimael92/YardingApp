...
// FilterSelect component exactly like EmployeeList
...
const UserManagement = () => {
  ...
  // Status badge styling exactly like EmployeeList
  ...
  // Role color styling exactly like EmployeeList
  const getRoleColor = (role: User["role"]) => {
    switch (role) {
      ...
      case "Client":
        return "text-[#8b4513]/60 dark:text-[#d4a574]/60 font-semibold"
      default:
  ...
  const handleBulkAction = async (action: "activate" | "deactivate" | "delete") => {
    ...
    if (!confirm(`Are you sure you want to ${actionText} ${selectedUsers.size} user(s)? This action cannot be undone.`)) {
      return
    }
  ...
  return (
    <div className="space-y-8">
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="text-sm text-[#b85e1a]/80 dark:text-gray-400 mt-1">
              Manage system users, roles, and access. Showing {filteredUsers.length} of {users.length} users.
            </p>
          </div>
          <div className="flex items-center gap-3">
            <button
              onClick={handleExport}
              className="px-4 py-2 text-sm font-medium text-[#8b4513] dark:text-[#d4a574] border border-[#d4a574] dark:border-[#8b4513] rounded-lg hover:bg-[#d4a574]/20 transition-all"
            >
            ...
            <button
              ...
              className="px-4 py-2 text-sm font-medium text-white bg-[#2e8b57] rounded-lg hover:bg-[#1f6b41] transition-all"
            >
      ...
      {/* Stats Cards - EXACTLY like EmployeeList */}
      <section className="space-y-3">
        <h2 className="text-sm font-semibold text-[#8b4513] dark:text-[#d4a574] uppercase tracking-wider">
          Overview
        </h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="rounded-xl border border-[#d4a574]/30 bg-white dark:bg-gray-800 p-5 transition-shadow hover:shadow-md">
            ...
            <div className="text-2xl font-bold text-[#8b4513] dark:text-[#d4a574] mt-1">{userStats.total}</div>
          </div>

          <div className="rounded-xl border border-[#2e8b57]/30 bg-[#2e8b57]/5 dark:bg-[#2e8b57]/10 p-5 transition-shadow hover:shadow-md">
            ...
            <div className="text-2xl font-bold text-[#2e8b57] dark:text-[#4a7c5c] mt-1">{userStats.active}</div>
          </div>

          <div className="rounded-xl border border-[#d88c4a]/30 bg-[#d88c4a]/5 dark:bg-[#d88c4a]/10 p-5 transition-shadow hover:shadow-md">
            ...
            <div className="text-2xl font-bold text-[#b85e1a] dark:text-[#d88c4a] mt-1">{userStats.pending}</div>
          </div>

          <div className="rounded-xl border border-[#8b4513]/30 bg-[#8b4513]/5 dark:bg-[#8b4513]/10 p-5 transition-shadow hover:shadow-md">
            <div className="flex items-center gap-2 text-[#8b4513] dark:text-[#d4a574]">
              <UsersIcon className="w-5 h-5 shrink-0" />
              <span className="text-xs font-medium uppercase tracking-wide">Admins</span>
            </div>
            <div className="text-2xl font-bold text-[#8b4513] dark:text-[#d4a574] mt-1">{userStats.admins}</div>
          </div>
        </div>
      </section>

      {/* Filters Section - EXACTLY like EmployeeList */}
      <section className="space-y-3">
        <h2 className="text-sm font-semibold text-[#8b4513] dark:text-[#d4a574] uppercase tracking-wider">
          Filters & Actions
        </h2>
          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <button
              ...
              className={`inline-flex items-center px-4 py-2 border rounded-lg text-sm font-medium transition-all ${showFilters
                  ...
                  : "border-[#d4a574] dark:border-[#8b4513] text-[#8b4513] dark:text-[#d4a574] bg-[#f5f1e6] dark:bg-gray-800 hover:bg-[#d4a574]/20"
                }`}
            >
              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    <FilterSelect
                      value={roleFilter}
                      onChange={(v) => setRoleFilter(v as User["role"] | "all")}
                      options={[
                  ...
                  <div>
                    ...
                    <FilterSelect
                      value={statusFilter}
                      onChange={(v) => setStatusFilter(v as User["status"] | "all")}
                      options={[
      ...
      {selectedUsers.size > 0 && (
        <div className="rounded-xl border border-[#2e8b57] bg-[#2e8b57]/10 p-4 dark:border-[#4a7c5c]">
      ...
      {/* Users Table - EXACTLY like EmployeeList */}
          ...
          <div className="border-b border-gray-200 bg-gray-50/50 px-6 py-4 dark:border-gray-700 dark:bg-gray-800/50">
            <div className="flex items-center justify-between">
              <h2 className="text-lg font-semibold text-gray-900 dark:text-white flex items-center gap-2">
                <UsersIcon className="w-5 h-5 text-[#2e8b57]" />
                Users
              </h2>
            ...
            <table className="min-w-full divide-y divide-[#d4a574]/20 dark:divide-[#8b4513]/20">
              <thead className="bg-[#f5f1e6] dark:bg-gray-800">
                <tr>
                  ...
                  <th className="px-4 py-3 text-left text-xs font-medium text-[#8b4513] dark:text-[#d4a574] uppercase tracking-wider">
                    User
                  </th>
                  <th className="px-4 py-3 text-left text-xs font-medium text-[#8b4513] dark:text-[#d4a574] uppercase tracking-wider">
                    Role
                ...
                {paginatedUsers.map((user, index) => {
                  ...
                  return (
                    <React.Fragment key={user.id}>
                      <tr className={`hover:bg-[#f5f1e6]/50 dark:hover:bg-gray-800/50 transition-colors ${isSelected ? "bg-[#2e8b57]/10 dark:bg-[#2e8b57]/20" : ""
                        }`}>
                        ...
                        <td className="px-4 py-3 text-sm text-[#8b4513] dark:text-[#d4a574]">
                          ...
                          <td colSpan={7} className="px-4 py-4">
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                              <div>
                                ...
                                <dd className="text-[#8b4513] dark:text-[#d4a574] font-mono text-xs">{user.id}</dd>
                              </div>
                              <div>
            ...
            <div className="px-6 py-4 border-t border-gray-200 dark:border-gray-700 flex items-center justify-between">
              ...
              <div className="flex items-center space-x-2">
                <button
                  ...
                  className="px-3 py-1 border border-[#d4a574] dark:border-[#8b4513] rounded bg-[#f5f1e6] dark:bg-gray-800 text-[#8b4513] dark:text-[#d4a574] disabled:opacity-50 disabled:cursor-not-allowed text-sm hover:bg-[#d4a574]/20 transition-colors"
                >
                  Previous
                </button>
                <span className="text-sm text-gray-600 dark:text-gray-400">
