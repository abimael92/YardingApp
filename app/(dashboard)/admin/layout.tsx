...
export default function AdminLayout({
  ...
  return (
    <RoleGate role="admin">
      <div className="flex min-h-screen bg-gradient-to-br from-amber-50/50 to-orange-50/50 dark:bg-gray-900 dark:from-gray-900 dark:to-gray-900 min-w-0">
        ...
        <div className="flex-1 min-w-0 w-full overflow-x-hidden lg:ml-0">
          ...
          <div className="bg-gradient-to-r from-amber-200/50 to-orange-100/60 dark:from-gray-800 dark:to-gray-800 border-b border-amber-200 dark:border-gray-700 px-3 py-3 sm:px-4 sm:py-4">
            <div className="flex items-center gap-2 sm:space-x-4">
              <button
                onClick={() => setSidebarOpen(true)}
                className="lg:hidden p-2 rounded-lg bg-amber-200 dark:bg-gray-700 text-amber-800 dark:text-gray-200 shrink-0 hover:bg-amber-300 dark:hover:bg-gray-600 transition-colors"
              >
              ...
              <div className="min-w-0">
                ...
                <h1 className="text-xl font-bold text-amber-900 dark:text-white sm:text-2xl">
                  {pageInfo.section}
                </h1>
                <p className="text-sm text-amber-700/80 dark:text-gray-400">
